export default {
	...
	da: {
		...
		signOut: 'Log ud',
		'accounts.details':
			'Opret og vedligehold dine konti. Hver konto bør indeholde udgifter af samme slags.',
		...
		'expense.isMonthly.explanation':
			'Dette er en månedtlig udgift, da den ikke har nogle betalingsdatoer',
